...
// Project imports:
import '../database/pill_tracker_database.dart' as _i12;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i12.PTDatabase>(
      () => registerModule.providePTDatabase(get<_i6.DatabaseConnection>()));
  ...
  gh.factory<_i25.GlobalViewModel>(() => _i25.GlobalViewModel(
      get<_i19.LocaleRepository>(), get<_i16.DebugRepository>()));
  gh.singleton<_i26.NetworkRefreshInterceptor>(_i26.NetworkRefreshInterceptor(
      get<_i15.AuthStorage>(), get<_i23.RefreshRepository>()));
