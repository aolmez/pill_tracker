...
const originalProjectName = 'pill_tracker';
const originalClassNamePrefix = 'PT';
const originalIOSBundleIdentifier = 'be.wive.pilltracker';
const originalAndroidPackageName = 'be.wive.pilltracker';
const originalAndroidFolderPath = 'be/wive/pilltracker';
const originalAppName = 'Pill tracker';
const originalDescription = 'A new William Project';
